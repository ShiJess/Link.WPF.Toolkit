...
{
    /// <summary>
    /// TODO 日期选择控件【可选时分秒】-参考官方DatePicker代码
    /// 
    /// 时间控件样式参考
    /// https://www.jianshu.com/p/ab2a16169bed
    /// https://blog.csdn.net/lianzhang861/article/details/80422513
    ...
    [TemplatePart(Name = DateTimePicker.ElementTextBox, Type = typeof(DatePickerTextBox))]
    ...
    [TemplatePart(Name = DateTimePicker.ElementTime, Type = typeof(TimePicker))]
    [TemplatePart(Name = DateTimePicker.ElementCalendar, Type = typeof(System.Windows.Controls.Calendar))]
    public class DateTimePicker : Control
    {
        ...
        private const string ElementTime = "PART_Time";
        ...
        private TimePicker _timerPicker;
        ...
        public static readonly RoutedEvent SelectedDateChangedEvent = EventManager.RegisterRoutedEvent("SelectedDateChanged", RoutingStrategy.Direct, typeof(EventHandler<SelectionChangedEventArgs>), typeof(DateTimePicker));
        ...
        public static readonly DependencyProperty DisplayDateProperty =
            DependencyProperty.Register("DisplayDate", typeof(DateTime), typeof(DateTimePicker),
        ...
        public static readonly DependencyProperty DisplayDateEndProperty =
            DependencyProperty.Register("DisplayDateEnd", typeof(DateTime?), typeof(DateTimePicker),
        ...
        public static readonly DependencyProperty DisplayDateStartProperty =
            DependencyProperty.Register("DisplayDateStart", typeof(DateTime?), typeof(DateTimePicker),
        ...
        private void Calendar_SelectedDatesChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                this.SetCurrentValue(SelectedDateProperty, (DateTime?)e.AddedItems[0]);
            }
            else
            {
                if (e.AddedItems.Count == 0)
                {
                    this.SetCurrentValue(SelectedDateProperty, (DateTime?)null);
                    return;
                }
        ...
        private void SetSelectedDate()
        {
            if (this._textBox != null)
            {
                if (!string.IsNullOrEmpty(this._textBox.Text))
                {
                    ...
                    {
                        this.SetCurrentValue(SelectedDateProperty, d);
                        this.SetCurrentValue(DisplayDateProperty, d);
                    }
                }
                else
                {
